      ...
      <div className="w-full max-w-lg space-y-8">
        <div className="text-center space-y-3">
          ...
          <div>
            ...
            <p className="text-text-secondary text-sm mt-1">Create a new workspace or join an existing one.</p>
          </div>
        </div>

        {mode === "choose" && (
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <button onClick={() => setMode("create")} className="card p-6 text-left hover:shadow-card-hover transition-all duration-200 hover:border-brand/30">
              <div className="w-10 h-10 bg-brand-light rounded-xl flex items-center justify-center mb-4">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#6366F1" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 5v14M5 12h14"/></svg>
              </div>
            ...
            <button onClick={() => setMode("join")} className="card p-6 text-left hover:shadow-card-hover transition-all duration-200 hover:border-brand/30">
              <div className="w-10 h-10 bg-success/10 rounded-xl flex items-center justify-center mb-4">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#10B981" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4M10 17l5-5-5-5M13.8 12H3"/></svg>
              </div>
